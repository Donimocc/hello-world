$(function() {
	//本版本与原版相比，希望加入单个一级导航栏的二级菜单的背景和color的记忆功能，让二级和三级导航栏能图文对应
	//主要修改代码见87行
	...
	function Header() {
		...
		function changeNav3handler(e) {
			...
			//修改是为了不用多写代码，一套代码用所有页面，这里通过children和parent方法，实现index的对应关系
...
//			console.log(e.parent().children(".nav2_in_right").children("li"))
		...
		nav2text.hover(function() {
			//这里这样写是只记忆最后一个hover的二级菜单，现在需要修改成每个子菜单有一个记忆的
			//						nav2text.css({
			//							"color": "white",
